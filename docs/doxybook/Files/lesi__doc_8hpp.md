---
title: include/cpp_robotics/optimize/lesi_doc.hpp

---

# include/cpp_robotics/optimize/lesi_doc.hpp
...
|                | Name           |
| -------------- | -------------- |
| void | **[lsei_](/cpp_robotics/doxybook/Files/lesi__doc_8hpp/#function-lsei-)**(double * C_mat, double * D_vec, double * E_mat, double * F_vec, double * G_mat, double * H_vec, int lc_eq_mat_rows, int mc_eq_mat_rows, int le_prob_mat_rows, int me_prob_mat_rows, int lg_ineq_mat_rows, int mg_ineq_mat_rows, int n, double * x, double * xnrm, double * w_lagrange_mul, int * jw, int * mode) |
